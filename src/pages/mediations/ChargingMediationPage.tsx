...
export function ChargingMediationPage() {
  ...
  const filteredFlows = chargingFlows.filter(flow =>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent">
                  Charging Gateway Mediation
                </h1>
                <p className="text-muted-foreground">
                  Monitor and manage charging gateway mediation flows
                </p>
              </div>
            </div>
          </div>
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <Button 
                          variant="outline" 
                          size="sm"
                          onClick={() => navigate(`/mediations/charging/flow/${flow.id}`)}
